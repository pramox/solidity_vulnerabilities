...
contract Congress is owned {
        ...
        function checkProposalCode(uint proposalNumber, address beneficiary, uint amount, bytes transactionBytecode) view returns(bool codeChecksOut) {
        ...
        function() {
                if (msg.value > priceOfAUnicornInFinney) {
                        ...
                        unicorn.mintToken(msg.sender, msg.value / (priceOfAUnicornInFinney * 1000000000000000));
                }
